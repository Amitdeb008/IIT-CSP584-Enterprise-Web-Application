...
import com.dev.sportshub.dao.FeedbackDao;
...
public class FeedbackServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		new FeedbackDao().saveFeedback(review, userid,eventDetails[0],eventDetails[1]);
		response.setHeader("message", "Thank you for providing your review");
