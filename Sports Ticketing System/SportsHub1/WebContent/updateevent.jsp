...
<%
	...
	if (session.getAttribute("adminid") == null) {
		...
		event = dao.getEventsById(eventId);
	}
%>
</head>
<body>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item active"><a href="createevent.jsp"
						class="nav-link">New Event</a></li>
				...
				<form class="m-auto col-sm-12" id="loginform" method="post"
					...
					<div class="form-label-group text-center">
						<div class="form-group row">
							<label class="col-sm-3 col-form-label" for="domain">Event
								Id: </label>
							<div class="col-sm-9">
								<input class="form-control" type="text" id="eventId"
									name="eventId" value="<%= event.getEventId() %>">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-3 col-form-label" for="domain">Event
						...
						<div class="form-group row">
							<label class="col-sm-3 col-form-label" for="domain">Sport
								Name: </label>
							<div class="col-sm-9">
								<input class="form-control" type="text" id="sportName"
									name="sportName" value="<%= event.getSportName() %>">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-3 col-form-label" for="domain">Group
								Name: </label>
							<div class="col-sm-9">
								<input class="form-control" type="text" id="groupName"
									name="groupName" value="<%= event.getGroupName() %>">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-3 col-form-label" for="domain">Event
						...
						<div class="form-group row">
							<label class="col-sm-3 col-form-label" for="domain">Event
								Place: </label>
							<div class="col-sm-9">
								<input class="form-control" type="text" id="eventPlace"
									name="eventPlace" value="<%= event.getEventPlace() %>">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-3 col-form-label" for="domain">Event
								City: </label>
							<div class="col-sm-9">
								<input class="form-control" type="text" id="eventCity"
									name="eventCity" value="<%= event.getEventCity() %>">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-3 col-form-label" for="domain">Event
								State: </label>
							<div class="col-sm-9">
								<input class="form-control" type="text" id="eventState"
									name="eventState" value="<%= event.getEventState() %>">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-3 col-form-label" for="domain">ZIP:
							</label>
							<div class="col-sm-9">
								<input class="form-control" type="text" id="eventZip"
									name="eventZip" value="<%= event.getEventZip() %>">
							</div>
						</div>
						<div class="form-group row">
