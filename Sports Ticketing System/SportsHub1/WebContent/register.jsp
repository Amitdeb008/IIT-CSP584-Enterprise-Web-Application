	...
	<div class="hero-wrap js-fullheight"
		...
		<div class="container">
			<div
				...
				<form class="m-auto" id="loginform" method="post" action="RegistrationServlet" style="background-color: #ddd;padding: 20px;color: #000;">
					...
					<div class="form-label-group text-center">
						<div class="form-group row">
							<label class="col-sm-3" for="domain">Name: </label>
							<div class="col-sm-9">
